...
@dp.transformation(sampled_features, get_categorical_features, display=False)
def reduce_categories_in_sampled_features(df: DataFrame, categorical_features: list):
    threshold = 80
